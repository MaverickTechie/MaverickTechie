...
```mermaid
graph LR
    Main[MaverickTechie Profile] --> R1[1. Customer Success Framework]
    Main --> R2[2. Observability & Eval Harness]
    Main --> R3[3. HR Tech Compliance Matrix]
    Main --> R4[4. Self-Healing HITL Core]

    style Main fill:#2dd4bf,stroke:#0f766e,stroke-width:2px,color:#000
    style R1 fill:#f1f5f9,stroke:#64748b,stroke-width:1px
    style R2 fill:#f1f5f9,stroke:#64748b,stroke-width:1px
    style R3 fill:#f1f5f9,stroke:#64748b,stroke-width:1px
    style R4 fill:#f1f5f9,stroke:#64748b,stroke-width:1px
```
